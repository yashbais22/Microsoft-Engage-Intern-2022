...
with open('D:/Movies-Recommendation-System/Data/movie_data.json', 'r+', encoding='utf-8') as f:
    data = json.load(f)
with open('D:/Movies-Recommendation-System/Data/movie_titles.json', 'r+', encoding='utf-8') as f:
...
def run() -> object:
    img1 = Image.open('D:/Microsoft-Project/Movies-Recommendation-System/meta/movielogo.png')
    img1 = img1.resize((700,150),)
    st.image(img1,use_column_width=False)
    st.title("Don't have the time to decide which movie to watch next?")
    st.markdown('''<h4 style='text-align: left; color: #E0DDAA;'>Don't worry get Movie recommendations instantly</h4>''',
    ...
    if cat_op == category[0]:
        ...
        st.markdown('''<h4 style='text-align: left; color: #E0DDAA;'>* Fetching a Movie Posters will take a time."</h4>''',
                    unsafe_allow_html=True)
        if dec == 'No':
